class Player {
  ...
  Player(String TPN, float tXpos, float tYpos, float tW, float tH, float tHU, char TCU, char TCD, char TCL, char TCR, char TCJ) {
    ...
    this.HU = tHU;
    this.controlUP = TCU;
    this.controlDOWN = TCD;
    this.controlLEFT = TCL;
    this.controlRIGHT = TCR;
    this.controlJUMP = TCJ;
    this.playerName = TPN;
